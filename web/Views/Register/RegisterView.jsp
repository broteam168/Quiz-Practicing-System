            ...
            <div class="container-regi">
                <div class="container__hedaer-regi">
                    ...
                    <div id="close_regibutton" class="container__header-close-regi">
                        ...
                        <path d="M18 18L12 12M12 12L6 6M12 12L18 6M12 12L6 18" stroke="#1D2026" 
                    ...
                    <form id="registerForm" method="post" action="register">
                        <div class="input-container-regi">
                            ...
                            <input required name="fullname" type="text" id="fullname" 
                                   class="input-field-regi" placeholder="Enter your full name">
                        </div>
                        ...
                        <div class="input-container-regi">
                            ...
                            <input required name="email" type="email" id="register-email" 
                                   class="input-field-regi" placeholder="Enter your email">
                        </div>
                        <div class="input-container-regi">
                            <label  for="mobile" class="input-label-regi">Mobile</label>
                            <input required name="mobile" type="tel" pattern="[0-9]{10}" 
                                   id="mobile" class="input-field-regi" placeholder="Enter your mobile">
                        </div>
                        <div class="input-container-regi">
                            <label  for="password" class="input-label-regi">Password</label>
                            <input required name="password" type="password" id="password-register" 
                                   class="input-field-regi" placeholder="Enter your password">
                        </div>
                        <div class="input-container-regi">
                            <label  for="password" class="input-label-regi">Confirm</label>
                            <input required name="password" type="password" id="confirm-password-register" 
                                   class="input-field-regi" placeholder="Confirm your password">
                        </div>
                        <button class="submit_button-regi">Continue</button>
                        <p id="message-register"></p>
                        <div class="login">
                            Already have an account?  
                            <div id="login-button-regi">
                                <a id="login-link" onclick="openLoginPopup()">Login in here!</a>
                            </div>
                        </div>
                    </form>
                </div>
