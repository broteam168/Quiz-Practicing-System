document.addEventListener('DOMContentLoaded', () => {
    ...
    $("#data__filter-btnsearch").click(function (event) {
        var newURL = replaceUrlParam(window.location.href, 'content', $('#myInputTextField').val());
        window.location.href = newURL;
    });
    $("#data__filter-btnsearch2").click(function (event) {
        var newURL = replaceUrlParam(window.location.href, 'content','');
        window.location.href = newURL;
    });
    $("#all").click(function () {
